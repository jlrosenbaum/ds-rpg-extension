...
import DSRPGActorHitPointsConfig from "./dsrpg-actor-hit-points-config.js";
import DSRPGActorOriginSummaryConfig from "./dsrpg-actor-origin-summary-config.js";

export const dsrpgListeners = function (html, actor, app) {
