 ...
 */
export default class DSRPGActorOriginSummaryConfig extends DSRPGBaseConfigSheet {
	constructor(...args) {
		super(...args);
	...
	static get defaultOptions() {
		return foundry.utils.mergeObject(super.defaultOptions, {
			...
			template: `modules/${CONSTANTS.MODULE_ID}/templates/actors/parts/dsrpg-origin-summary-config.html`,
			width: 320,
			height: "auto",
			sheetConfig: false
		});
	...
	/** @inheritdoc */
	get title() {
		return `${game.i18n.localize("DSRPG.OriginSummaryConfig")}: ${this.document.name}`;
	}
